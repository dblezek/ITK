...
std::string ImageSHA1Hash ( itk::Image<float,3>* image ) { return itk::testing::ImageSHA1Hash ( image ); }
std::string ImageSHA1Hash ( itk::Image<short,3>* image ) { return itk::testing::ImageSHA1Hash ( image ); }
std::string ImageSHA1Hash ( itk::Image<char,3>* image ) { return itk::testing::ImageSHA1Hash ( image ); }
std::string ImageSHA1Hash ( itk::Image<float,2>* image ) { return itk::testing::ImageSHA1Hash ( image ); }
std::string ImageSHA1Hash ( itk::Image<short,2>* image ) { return itk::testing::ImageSHA1Hash ( image ); }
std::string ImageSHA1Hash ( itk::Image<char,2>* image ) { return itk::testing::ImageSHA1Hash ( image ); }


namespace itk {
  namespace testing {
    DataFinder::DataFinder () { m_Directory = "NotFoundAnywhere"; };
